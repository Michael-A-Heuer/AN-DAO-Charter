...
\newglossaryentry{AragonNetwork2}{
	type=add,
	name={Aragon Network},
	description={
...
\newglossaryentry{EthereumNameService}{
	...
	name={\ac{ENS}},
	description={
		a smart contract-based naming system. \ac{ENS} names are registered using the registry deployed at the Ethereum address \href{https://etherscan.io/address/0x00000000000C2E074eC69A0dFb2997BA6C7d2e1e}{\texttt{0x00000000000C2E074eC69A0dFb2997BA6C7d2e1e}}.
	}
}
