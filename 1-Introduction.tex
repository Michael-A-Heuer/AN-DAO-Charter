...
\charterchapter{Introduction to the Charter}
...
\begin{enumerate}
	\sectionitem{Applicable Rules to the Aragon Network}
	\begin{enumerate}
		...
		\begin{enumerate}
			...
			\item \hyperref[chap:AGPProcess]{\acl{AGP} Process}
	...
	\end{enumerate}
	\sectionitem{General Legal Principles}
	...
	each of the aforementioned shall be liable only for its obligations (and not those of anyone else) under this Charter or in connection with this Charter or with the \gls{AragonNetwork}.
