...
\begin{enumerate}
	...
	\begin{enumerate}
		...
		\item \textbf{Aragon Court:}\todo{Ref?} Used to challenge the actions scheduled on both the Main \ac{DAO} and any Sub-\ac{DAO}, and directly from the Voice UI / or the custom UI for AN \ac{DAO}.
	\end{enumerate}
