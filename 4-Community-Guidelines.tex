...
\charterchapter{The Community Guidelines}
\label{chap:CommunityGuidelines}

\chartersection{Code of Conduct}
...
\begin{itemize}
	...
	\item Publishing other's private information, including \ac{PII}\todo{acronyms needed? appear only once} such as a physical address or email address, without their explicit permission.
...
\chartersection{Violations and Consequences}
...
\chartersubsection{1. Correction}\todo{Numbering needed? Other subsection in this document are not numbered.}
\textbf{Community Impact:} A single use of inappropriate language or other behavior deemed unwelcome in the community.

\textbf{Consequence:} Deletion or removal of the post in question, in addition to communicating which rule was violated and how to avoid such violations in the future. If the action was in person, direct communication with that individual to identify which rule was violated and how to avoid such violations in the future.

\chartersubsection{2. Warning}
...
\chartersubsection{3. Temporary Ban}
...
\chartersubsection{4. Permanent Ban}
...
\chartersection{Reporting and Enforcement}
